...
var _user$project$FakeData$chartItems = _elm_lang$core$Native_List.fromArray(
	[
		{country: 'USA', visits: 252},
		{country: 'China', visits: 882},
...
var _user$project$Main$updateItemsWithRandom = function (model) {
	...
	var items = A2(
		...
		A3(
			...
			_elm_lang$core$Basics$fst(randomData),
			model.items));
	return {
		ctor: '_Tuple2',
		_0: items,
		_1: _elm_lang$core$Basics$snd(randomData)
	};
};
			...
			case 'ToggleExtraInfo':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							showExtraInfo: _elm_lang$core$Basics$not(model.showExtraInfo)
						}),
			...
			default:
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							seed: _elm_lang$core$Basics$snd(updatedItems),
							items: _elm_lang$core$Basics$fst(updatedItems)
						}),
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$Main$ToggleExtraInfo)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$Main$UpdateChartData)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_user$project$Main$viewExtraInfo(model),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
